...
namespace Ahorcado_Estados.Negocios
{
    public class RatePopup
    {
        ...
        /// <summary>
        /// The default number of times the application needs to be launched before showing the reminder for second time. The default value is 10.
        /// </summary>
        public static readonly int DefaultLaunchLimit2ForReminder = 10;
        ...
        /// <summary>
        /// The number of times the applications needs to be launched before showing the reminder for the second time. The default value is <see cref="RatePopup.DefaultLaunchLimitForReminder2"/>.
        /// </summary>
        public static int LaunchLimit2
        {
            get;
            set;
        }
        ...
        {
            Title = "Rate us!";
            Content = "Your feedback helps you improve this app. If you like it, please take a minute and rate it so we can continue working on new features and updates. Thank you.";
            RateButtonText = "Rate this app";
            CancelButtonText = "No, thanks";
            LaunchLimit = DefaultLaunchLimitForReminder;
            LaunchLimit2 = DefaultLaunchLimit2ForReminder;
        ...
        public static void CheckRateReminder()
        {
            ...
            {
                LaunchCount = (int)reminderContainer.Values[CountPropertyName];
                LaunchCount++;
                reminderContainer.Values[CountPropertyName] = LaunchCount;

                if (LaunchCount == LaunchLimit ||
                    LaunchCount == LaunchLimit2)
                {
                    ShowRate();
                }
            }
